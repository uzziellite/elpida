export const POST: APIRoute = async ({ request }) => {
  if (request.headers.get("Content-Type") === "application/json") {
    ...
    //for compatibility with cpntact form 7
    ...
    await fetch(`${import.meta.env.PUBLIC_CMS}wp-json/contact-form-7/v1/contact-forms/${import.meta.env.SECRET_FORM_ID}/feedback`, {
      method: 'POST',
      headers: {
